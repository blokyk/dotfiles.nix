# this is a slight modification of home-manager's programs.gnome-shell module,
# which doesn't automatically add the entirety of `pkgs.gnome-shell-extensions`
# (which contains a bunch of irrelevant extensions)
    ...
    lib.mkMerge [
      ...
      (lib.mkIf (cfg.theme != null) {
        ...
        programs.gnome-shell.extensions = [{
          package = pkgs.gnomeCurrentExtensions."user-theme@gnome-shell-extensions.gcampax.github.com";
        }];
